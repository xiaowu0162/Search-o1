...
def main():
    ...
    # else:
    output_dir = f'./outputs/runs.raghint/{dataset_name}.{model_short_name}/{args.retrieval_exp_name}/{args.augmentation_strategy}/'
    ...
    for item in filtered_data:
        ...
        if args.augmentation_strategy == 'top1-in-thinking':
        ...
        # print(json.dumps(retrieved_hints, indent=4))
        # print(prompt)
        # exit()
