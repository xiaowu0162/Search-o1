...
def main():
    ...
    if 'qwq' in model_path.lower():
        if dataset_name in ['math500', 'gpqa', 'aime', 'amc', 'livecode']:
            output_dir = f'/home/u2023000153/Projects/2024/Retro_O1/outputs/{dataset_name}.qwq.rag_agent'
        else:
            output_dir = f'/home/u2023000153/Projects/2024/Retro_O1/outputs/runs.qa/{dataset_name}.qwq.rag_agent'
    else:
        model_short_name = model_path.split('/')[-1].lower().replace('-instruct', '')
        output_dir = f'/home/u2023000153/Projects/2024/Retro_O1/outputs/runs.baselines/{dataset_name}.{model_short_name}.rag_agent'
